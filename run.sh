...
cp /home/steam/Game.ini /ark/Game.ini
...
[ ! -L /ark/Game.ini ] && cp /home/steam/Game.ini Game.ini
[ ! -L /ark/GameUserSettings.ini ] && cp /home/steam/GameUserSettings.ini GameUserSettings.ini
